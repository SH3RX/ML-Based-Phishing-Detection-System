...
# 1 A FUNCTION THAT OPENS A HTML FILE AND RETURNS THE CONTENT
file_name = "mini_dataset/4.html"
...
# 2 A FUNCTION THAT CREATES A BEATIFULSOUP OBJECT
def create_soup(text):
    return BeautifulSoup(text, "html.parser")


# 3 A FUNCTION THAT CREATES A VECTOR BY RUNNING ALL FEATURE FUNCTIONS FOR THE SOUP OBJECT
